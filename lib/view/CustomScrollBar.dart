...
const Duration _kScrollbarFadeDuration = Duration(milliseconds:600);
...
class _CustomScrollBarState extends State<CustomScrollBar> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if(widget.scrollColor != null)
      _themeColor = widget.scrollColor;
  }
  ...
  void didChangeDependencies() {
    ...
    switch (theme.platform) {
      ...
      case TargetPlatform.windows:
        _themeColor = theme.highlightColor.withOpacity(0.7);
